...
Covers AIME I and AIME II from 2010-2025.
"""
...
def main():
    """Download ASY PNG images for all AIME contests 2010-2025."""
    print("=" * 60)
    print("AIME ASY PNG Downloader")
    print("Downloading PNG images for ASY blocks from 2010-2025")
    print("=" * 60)
