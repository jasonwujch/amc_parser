#!/usr/bin/env python3
"""
AMC12 ASY PNG Downloader - Download PNG images for Asymptote diagrams
Downloads rendered PNG images for all [asy]...[/asy] blocks from AMC12 problems.
Covers AMC 12A and AMC 12B from 2002-2025.
"""
...
def main():
    """Download ASY PNG images for all AMC12 contests 2002-2025."""
    print("=" * 60)
