...
These problems are copyrighted © by the Mathematical Association of America. Usage of the Prime Number 2 Note that two is the only even prime number. So, in order for this expression to result in a prime number, the result must be 2. You can factor the quadratic equation and eventually see that 3 is the only number satisfying this condition. Hence, the answer is B.
