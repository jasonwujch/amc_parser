...
## Solution 1 (Competition Speed and No Summation Notation)
...
## Solution 12 (approachable and easy)
...
~AmyInRetrograde
You can also use the infinite geometric sequence formula for the $\frac{1}{2}\cdot\frac{1}{2}+\frac{1}{4}\cdot\frac{1}{4}+\ldots$ to get $\frac{1}{2}\cdot\frac{1}{2}+\frac{1}{4}\cdot\frac{1}{4}+\ldots$ $=$ $\frac{\frac{1}{4}}{1-\frac{1}{4}}$ $=$ $\frac{\frac{1}{4}}{\frac{3}{4}}$ $=$ $\boxed{\frac{1}{3}}$
~Marshall_Huang
