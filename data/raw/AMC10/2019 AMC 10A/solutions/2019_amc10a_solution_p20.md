...
We could also calculate the probability of all the even numbers being grouped, which can only happen in 4 ways. This is similar to the solution above but requires less work. Solving you would get $1/56$ for the 4 even numbers to be grouped together, but you must multiplfy by 4 to account for the 4 corners. Solving, your answer is 1/14 ~petallstorm ~(minor edits by Bobnotbob)
