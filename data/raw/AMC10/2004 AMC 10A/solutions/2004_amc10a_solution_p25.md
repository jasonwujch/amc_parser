...
By the Pythagorean Theorem , we have $\left(\frac{2}{\sqrt{3}}\right)^2 + h^2 = 3^2 \Longrightarrow h = \frac{\sqrt{69}}{3}$ . Adding the heights up, we get $\frac{\sqrt{69}}{3} + 1 + 2 \Rightarrow 3+\frac{\sqrt{69}}{3}$ , or $\boxed{B}$
